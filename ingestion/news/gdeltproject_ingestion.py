...
#API ingestion with mode = timelinetone
...
if response.status_code == 200:
    ...
    created_file_path = output_dir / "news_tone.json"
...
#API ingestion with mode = timelinevolraw
params = {
    "query": "(bitcoin OR btc)",
    "mode": "timelinevolraw",
    "startdatetime": "20250101000000",
...
if response.status_code == 200:
    ...
    created_file_path = output_dir / "news_volume.json"
